...
function CubeControl(gameManager)
	...
	this.OnButtonClick = function(gameObject , position , hovered)
		...
		gameManager.getPlayControl().changeAnimation();
...
--[[
	...
	this.OnClick = function(gameObject , position , hovered)
		...
		local ImageObject = UnityEngine.GameObject.Find("GameScene(Clone)")
	...
	local function init()
		...
		resMgr:LoadPrefab("resources" , {"GameScene"} , OnLoadTFinish)			--加载对应的		
