...
public class My_LuaComponentWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(My.LuaComponent), typeof(UnityEngine.MonoBehaviour));
	...
	static int Add(IntPtr L)
	{
		try
		{
			...
			LuaInterface.LuaTable o = My.LuaComponent.Add(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int Get(IntPtr L)
	{
		try
		{
			...
			UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.CheckUnityObject(L, 1, typeof(UnityEngine.GameObject));
			LuaTable arg1 = ToLua.CheckLuaTable(L, 2);
			LuaInterface.LuaTable o = My.LuaComponent.Get(arg0, arg1);
			ToLua.Push(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int get_table(IntPtr L)
	{
		...
		try
		{
			...
			My.LuaComponent obj = (My.LuaComponent)o;
