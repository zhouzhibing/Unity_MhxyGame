...
public class Packager {
    ...
    static void HandleExampleBundle() {
		...
		AddBuildMap("resources" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Resources/Prefabs");
		AddBuildMap("resource_sprites" + AppConst.ExtName, "*.png", "Assets/LuaFramework/Resources/Sprites");
    }
